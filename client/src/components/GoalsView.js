...
function GoalsView({ allGoals, handleGoal, userList, handleTask }){
//STRUCTURE:
//h1
//AddGoal
//DisplayGoals
  ...
  return(
    <>
      ...
      <DisplayGoals allGoals={allGoals} handleGoal={handleGoal} userList={userList} handleTask={handleTask}/>
    </>
  )
}
